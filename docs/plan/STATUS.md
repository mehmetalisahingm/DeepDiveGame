...
| P3.3 Sandal, harita ve gidiş/dönüş | Mehmet hareket/koltuk/konum; Utku rota/koordinat; Mert onarım/harita UI/kayıt | **DEVAM** — #75/#76/#66 entegrasyonu `codex/p3-integration`'da birleşti. Gerçek 2 süreçli `-Boat` koşusu 2026-09-24'te geçti: üç parça onarım + gizleme, iki koltuk, `Docked→Outbound→Anchored→Inbound→Docked`, demirde iniş/binme, sahiplik devri ve dock çıkışı (`docs/reports/P3-BOAT-RUNTIME-ACCEPTANCE.md`, ham kayıt `Logs/P1-integrated-20260924-233113-783-2`). EditMode 633/633. Oyuncu-facing harita UI'sı, dört süreç ve ayrı bilgisayar/internet kabulü hâlâ açık |
