...
- Ortak URP kamera/ışık/küp örneği, Windows build komutu ve Utku'nun Git düzeni [PR #8](https://github.com/mehmetalisahingm/DeepDiveGame/pull/8) ile main'e birleşti. Mehmet ve Mert güncel main'i açıp Windows build'ini çalıştırdı; Utku'nun sonucu bekleniyor.
...
- MertKAYAR ve Utkuuzun14 write davetlerini kabul etti. Utku'nun PR #7, Mert'in PR #10 değişikliği main'e birleşti. Mert'in kurulum/build testi geçti; P0 için Utku'nun sonucu bekleniyor.
...
| Ekip erişim testi | Üç hesabın erişimi aktif. Mert güncel main'i aldı ve projeyi açtı; P0 kapanışı için Utku'nun aynı kontrolü bekleniyor |
| Örnek build | `P0-A-9596244`, kaynak `9596244`; [yayınlanmamış Windows ZIP](https://github.com/mehmetalisahingm/DeepDiveGame/releases), [kurulum/build rehberi](../SETUP.md). Mehmet ve Mert'in Windows build kontrolleri başarılı; Utku'nun sonucu bekleniyor |
